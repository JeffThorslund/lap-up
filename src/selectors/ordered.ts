...
const appendNameAndParseResults = ([id, record]: [id: Id, record: ResultRecord]): OrderedSelectorResults => {
  return {
    id,
    name: record.name,
...
export const sortByBestResultIfExists = (a: CompleteComputedRaceInstance | undefined, b: CompleteComputedRaceInstance | undefined): number => {
...
const getFullResults = (result: ComputedRaceInstance): CompleteComputedRaceInstance => {
